	...
	public function databaseStructure ()
	{
		...
		$sql = "
			CREATE TABLE `administrators` (
			  `username` varchar(255) PRIMARY KEY NOT NULL COMMENT 'Username',
			...
			CREATE TABLE `settings` (
			  ...
			  `feedbackRecipient` varchar(255) NOT NULL COMMENT 'Feedback recipient e-mail',
			  `introductionHtml` text NOT NULL COMMENT 'Introductory text',
			  `orderingHtml` text NOT NULL COMMENT 'Ordering page',
			  ...
			  `shoppingCartPathwayId` VARCHAR(255) NULL COMMENT 'Shopping cart pathway ID',
			  `shoppingCartDepartmentId` VARCHAR(255) NULL COMMENT 'Shopping cart department ID',
			  `shoppingCartPayoptionCode` VARCHAR(255) NULL COMMENT 'Shopping cart pay option code',
			...
			CREATE TABLE `books` (
			  ...
			  `priceIncludesVat` enum('N','Y') NOT NULL DEFAULT 'N',
			  `photographFilename` varchar(255) DEFAULT NULL,
			  ...
			  `binding` enum('Hardback','Paperback') NOT NULL DEFAULT 'Hardback',
			...
			CREATE TABLE `cards` (
			  ...
			  `title` varchar(255) NOT NULL,
			  `pricePerUnit` float(5,2) NOT NULL DEFAULT '0.00',
			  `priceIncludesVat` enum('N','Y') NOT NULL DEFAULT 'Y',
			  `photographFilename` varchar(255) DEFAULT NULL,
			  `stockAvailable` int(10) UNSIGNED NOT NULL DEFAULT '0',
			  `stockIdealLevel` int(10) UNSIGNED DEFAULT NULL,
			  `stockMinimumLevel` int(10) UNSIGNED DEFAULT NULL,
			  ...
			  `message` varchar(255) NOT NULL DEFAULT 'Blank',
			...
			CREATE TABLE `clothing` (
			  ...
			  `priceIncludesVat` enum('N','Y') NOT NULL DEFAULT 'Y' COMMENT 'Price includes VAT?',
			  ...
			  `visible` enum('N','Y') NOT NULL DEFAULT 'Y' COMMENT 'Visible?',
			...
			CREATE TABLE `multimedia` (
			  ...
			  `colour` enum('Colour','Black & white','Not applicable','Unknown') NOT NULL DEFAULT 'Colour',
			...
			CREATE TABLE `posters` (
			  ...
			  `type` enum('Poster','Picture','Photograph','Facsimile reproduction','Calendar','Black frame','Black ash frame') NOT NULL DEFAULT 'Poster',
			  `colour` enum('Colour','Black & white','Unknown') NOT NULL DEFAULT 'Colour',
			  `sizeWidthInCm` int(10) UNSIGNED NOT NULL DEFAULT '0',
			  `sizeHeightInCm` int(10) UNSIGNED NOT NULL DEFAULT '0',
			...
			CREATE TABLE `toys` (
			  ...
			  `relatedInstitution` varchar(255) DEFAULT NULL,
			  `safety` text,
			  `material` text,
			  `externalPurchaseUrl` VARCHAR(255) NULL COMMENT 'External purchasing link'
			) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
			...
			CREATE TABLE `_booksSubtypes` (
			  ...
			  `subtypeName` varchar(255) NOT NULL COMMENT 'Name of book subtype',
			...
			) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Book subtypes';
			...
			CREATE TABLE `_clothingTypes` (
			  `id` int(11) PRIMARY KEY NOT NULL AUTO_INCREMENT COMMENT '#',
			  `photographFilename` varchar(85) DEFAULT NULL COMMENT 'Photo',
			...
			) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Announcement';
			...
			) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Featured items';
			
			CREATE TABLE `__sectionData` (
			  `id` varchar(85) PRIMARY KEY NOT NULL DEFAULT '',
			  `title` varchar(255) NOT NULL COMMENT 'Title (on front page)',
			  `singular` varchar(85) NOT NULL DEFAULT '',
			  `plural` varchar(85) NOT NULL DEFAULT '',
			  `hide` tinyint DEFAULT NULL COMMENT 'Hide?'
			) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='* Product categories';
			...
			) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Items to be added to thematic groupings';
			
			CREATE TABLE `__themeTypes` (
			  `id` varchar(85) PRIMARY KEY NOT NULL,
			  `title` varchar(255) NOT NULL COMMENT 'Name',
			  `singular` varchar(85) NOT NULL,
			  `plural` varchar(85) NOT NULL,
			  `description` text,
			  `enabled` ENUM('Yes','No') NOT NULL DEFAULT 'Yes' COMMENT 'Enabled?'
			) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Available themes';
			
			CREATE TABLE `__variationHeadings` (
			  `columnName` varchar(191) PRIMARY KEY NOT NULL,
			  `englishNameOrNull` varchar(255) NOT NULL
			) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Variation headings';
		;";
		...
		if ($this->enableShoppingCart) {
			$sql .= "
				CREATE TABLE `shoppingcart` (
				  ...
				  `provider` varchar(255) NOT NULL COMMENT 'Shop product provider',
				  `item` varchar(255) NOT NULL COMMENT 'Item number',
				  `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Automatic timestamp',
				  `url` varchar(255) NOT NULL COMMENT 'URL of item',
				  `name` varchar(255) NOT NULL COMMENT 'Name of item',
				  `image` varchar(255) DEFAULT NULL COMMENT 'Image of item',
				...
				) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Shopping cart session information (do not edit)';
				
				CREATE TABLE `shoppingcartOrders` (
				  `id` int(11) PRIMARY KEY NOT NULL AUTO_INCREMENT COMMENT 'Order no.',
				  `collectionDetails` varchar(255) DEFAULT NULL COMMENT 'Collection details',
				  `comments` text COMMENT 'Any other comments',
				  `sundries` text COMMENT 'Sundries (if any)',
				...
				) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Shopping cart inquiry form';
			;";
		}
	...
	public function main ()
	{
		...
		if ($this->enableShoppingCart) {
			$shoppingCartSettings = array (
				...
				'pathwayId'				=> $this->settings['shoppingCartPathwayId'],
				'departmentId'			=> $this->settings['shoppingCartDepartmentId'],
				'payoptionCode'			=> $this->settings['shoppingCartPayoptionCode'],
